...
//   }
  ...
  constructTrackedObjects(objects_obsved, &objects_trackable_transformed, options);
 ...
 */
// void HmTrackingWorker::constructTrackedObjectShapeFeature(TrackableObjectPtr object_tracked) {
//   ObjectPtr& temp_object = object_tracked->object_ptr;
//   feature_extractor_->compute(*(temp_object->cloud), &temp_object->shape_features);
// }
 ...
 * @param pose
 */
// void HmTrackingWorker::transformTrackedObject(TrackableObjectPtr object_tracked, const Eigen::Matrix4d& pose) {
//   //  航向角转换
//   //   Transform center 地表中心/重心转换到世界坐标系
//   //   Transform cloud & polygon 点云和2D边框转换
...
//   barycenter = (pose * Eigen::Vector4d(barycenter(0), barycenter(1), barycenter(2), 1)).head(3).cast<float>();
// }
